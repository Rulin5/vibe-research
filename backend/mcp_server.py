"""清数智算 MCP server —— 把 A股数据工具暴露给 Claude Code 等 agent。
...
挂进 Claude Code：
    claude mcp add qingshu -- /路径/backend/.venv/bin/python /路径/backend/mcp_server.py
...
SERVER_INFO = {"name": "qingshu", "version": read_version()}
