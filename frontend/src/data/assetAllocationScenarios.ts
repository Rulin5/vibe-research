...
export const ASSET_ALLOCATION_SCENARIOS: AssetAllocationScenario[] = [
  {
    ...
    allocation: [
      ...
      { id: "equity", label: "宽基权益", description: "仅以长期闲置资金承担分散化的权益波动。", percentage: 5, exampleAmount: 2_500, color: "#f59e0b" },
  ...
  },
  {
    ...
    allocation: [
      ...
      { id: "equity", label: "宽基权益", description: "只放入可长期持有、能接受阶段性波动的资金。", percentage: 10, exampleAmount: 30_000, color: "#f59e0b" },
  ...
  },
  {
    ...
    allocation: [
      ...
      { id: "equity", label: "宽基权益", description: "以高度分散的长期权益敞口保留有限增长空间。", percentage: 15, exampleAmount: 150_000, color: "#f59e0b" },
  ...
  },
  {
    ...
    allocation: [
      ...
      { id: "equity", label: "宽基权益", description: "保留受限的长期权益比例，避免单一市场或行业集中。", percentage: 20, exampleAmount: 600_000, color: "#f59e0b" },
